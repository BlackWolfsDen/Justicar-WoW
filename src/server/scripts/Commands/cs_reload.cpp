...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        static ChatCommand reloadCommandTable[] =
        {
	     ...
	     { "gameobject_template",	    SEC_ADMINISTRATOR, true,  &HandleReloadObjectPrototypesCommand,		 "", NULL },
            ...
            { "creature_template_all",        SEC_ADMINISTRATOR, true,  &HandleReloadCreatureTemplateAllCommand,        "", NULL },
    ...
    static bool HandleReloadObjectPrototypesCommand(ChatHandler* handler, const char* /*args*/)
    {
    ...
    {
        sLog->outString( "Loading NPC Text Data... (`npc_text`)" );
    ...
    {
        sLog->outString("Reloading chat_filter table...");
