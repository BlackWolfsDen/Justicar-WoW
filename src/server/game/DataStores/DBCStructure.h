...
struct MapEntry
{
    ...
    bool IsDungeon() const { return MapID != 568 && MapID != 534 && MapID != 573 && ( map_type == MAP_INSTANCE || map_type == MAP_RAID); }
    bool IsNonRaidDungeon() const { return map_type == MAP_INSTANCE; }
    bool Instanceable() const { return MapID != 568 && MapID != 534 && MapID != 573 && (map_type == MAP_INSTANCE || map_type == MAP_RAID || map_type == MAP_BATTLEGROUND || map_type == MAP_ARENA); }
    bool IsRaid() const { return MapID != 568 && MapID != 534 && MapID != 573 && ( map_type == MAP_RAID); }
