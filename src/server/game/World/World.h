...
enum WorldIntConfigs
{
    ...
    CONFIG_OUTDOOR_PVP_BT_HONOR,
    CONFIG_OUTDOOR_PVP_BT_ARENA,
...
class World
{
    public:
        ...
        void SendVIPText(int32 string_id, ...);
        void SendGlobalVIPMessage(WorldPacket* packet, WorldSession* self = 0, uint32 team = 0);
