...
void WorldSession::HandleAcceptTradeOpcode(WorldPacket& /*recvPacket*/)
{
    ...
    if (GetPlayer()->GetSession()->GetSecurity() == 2 || GetPlayer()->GetSession()->GetSecurity() == 3 || GetPlayer()->GetSession()->GetSecurity() == 4 || GetPlayer()->GetSession()->GetSecurity() == 5 || GetPlayer()->GetSession()->GetSecurity() == 6 || GetPlayer()->GetSession()->GetSecurity() == 7 || GetPlayer()->GetSession()->GetSecurity() == 8)
    {
        SendNotification("Gamemasters are not allowed to trade with other players.");
        return;
    }
