...
void BattlegroundAV::HandleKillUnit(Creature* unit, Player* killer)
{
    ...
    */
    ...
    else if (entry == 75025 || entry == 75026 || entry == 75027 || entry == 75028 || entry == 75029 || entry == 75030 || entry == 75031 || entry == 75032 || entry == 75033 || entry == 75034 || entry == 75035 || entry == 75036 || entry == 75037 || entry == 75038 || entry == 75039 || entry == 75040 || entry == 75041 || entry == 75042)
    {
        UpdateScore(ALLIANCE, -5);

        Creature* creature = GetBGCreature(AV_CPLACE_HERALD);
        if (creature)
        	YellToAll(creature, GetTrinityString(LANG_BG_AV_A_VEHICLE_DEAD), LANG_UNIVERSAL);
    }
    else if (entry == 75043 || entry == 75044 || entry == 75045 || entry == 75046 || entry == 75047 || entry == 75048 || entry == 75049 || entry == 75050 || entry == 75051 || entry == 75052 || entry == 75053 || entry == 75054 || entry == 75055 || entry == 75056 || entry == 75057 || entry == 75058 || entry == 75059 || entry == 75060)
    {
        UpdateScore(HORDE, -5);

        Creature* creature = GetBGCreature(AV_CPLACE_HERALD);
        if (creature)
            YellToAll(creature, GetTrinityString(LANG_BG_AV_H_VEHICLE_DEAD), LANG_UNIVERSAL);
    }
