        ...
        if (team == winner)
        {
           switch(player->GetMapId())
           {
                case 30: // Alterac Valley
	             player->AddItem(28558, 5);
		      ChatHandler(player->GetSession()).PSendSysMessage("You have been awarded with an Alterac Valley token for winning this battleground.");
                    break;
                case 489: // Warsong Gulch
	             player->AddItem(20880, 2);
		      ChatHandler(player->GetSession()).PSendSysMessage("You have been awarded with a battlemasters token for winning this battleground.");
                    break;
                case 529: // Arathi Basin
	             player->AddItem(50881, 2);
		      ChatHandler(player->GetSession()).PSendSysMessage("You have been awarded with a battlemasters token for winning this battleground.");
                    break;
                case 566: // Eye of the Storm
	             player->AddItem(50880, 2);
		      ChatHandler(player->GetSession()).PSendSysMessage("You have been awarded with a battlemasters token for winning this battleground.");
                    break;
                case 607: // Strand of the Ancients
	             player->AddItem(50882, 2);
		      ChatHandler(player->GetSession()).PSendSysMessage("You have been awarded with a battlemasters token for winning this battleground.");
                    break;
                default:
                    break;
           ...
           switch (urand(0,12))
           {
                case 0: player->AddItem(19182, 1);
                    player->AddItem(29438, 20);
                    break;
                case 1: player->AddItem(20880, 5);
                    player->AddItem(29437, 2);
                    break;
                case 2: player->AddItem(19182, 2);
                    player->AddItem(29438, 10);
                    break;
                case 3: player->AddItem(29438, 20);
                    player->AddItem(29437, 2);
                    break;
                case 4: player->AddItem(29438, 15);
                    player->AddItem(29437, 2);
                    break;
                case 5: player->AddItem(64328, 2);
                    player->AddItem(29437, 2);
                    break;
                case 6: player->AddItem(19182, 1);
                    player->AddItem(29438, 17);
                    break;
                case 7: player->AddItem(64328, 2);
                    player->AddItem(29437, 2);
                    break;
                case 8: player->AddItem(34597, 10);
                    player->AddItem(29438, 8);
                    break;
                case 9: player->AddItem(19182, 2);
                    player->AddItem(29437, 2);
                    break;
                case 10: player->AddItem(5551, 15);
                    player->AddItem(29437, 2);
                    break;
                case 11: player->AddItem(5597, 5);
                    player->AddItem(29437, 2);
                    break;
                case 12: player->AddItem(5598, 2);
                    player->AddItem(29437, 2);
                    player->AddItem(29438, 10);
                    break;
           }
...
void Battleground::AddPlayer(Player* player)
{
    ...
    {
    player->RemoveAura(48161);              // Power Word: Fortitude
    player->RemoveAura(48073);              // Divine Spirit
    player->RemoveAura(20217);              // Blessing of Kings
    player->RemoveAura(48469);              // Mark of the wild
    player->RemoveAura(16609);              // Spirit of Zandalar
    player->RemoveAura(15366);              // Songflower Serenade
    player->RemoveAura(22888);              // Rallying Cry of the Dragonslayer
    player->RemoveAura(57399);              // Well Fed
    player->RemoveAura(17013);              // Agamaggan's Agility
    player->RemoveAura(16612);              // Agamaggan's Strength
    player->RemoveAura(24705);
    player->RemoveAura(26035);
    player->RemoveAura(31305);
    player->RemoveAura(36001);
    player->RemoveAura(70235);
    player->RemoveAura(70242);
    player->RemoveAura(70244);
    player->RemoveAura(30090);
    player->RemoveAura(30088);
    player->RemoveAura(30089);
    }
    ...
    player->SetFloatValue(OBJECT_FIELD_SCALE_X, 1.0);
...
void Battleground::SetBracket(PvPDifficultyEntry const* bracketEntry)
{
    ...
    SetLevelRange(bracketEntry->minLevel,((bracketEntry->minLevel >= 75) ? 255 : bracketEntry->maxLevel));
}
