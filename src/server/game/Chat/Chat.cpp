...
ChatCommand* ChatHandler::getCommandTable()
{
    ...
    {
	 { "removeaura",	SEC_PLAYER,	      false, OldHandler<&ChatHandler::HandleRemoveCustomAuras>,	   "", NULL },
	 { "resetinstances",	SEC_PLAYER,	      false, OldHandler<&ChatHandler::HandleResetInstancesCommand>,	   "", NULL },
	 { "berserk",		SEC_PLAYER,	      false, OldHandler<&ChatHandler::HandleBerserkCommand>,		   "", NULL },
	 { "premium",		SEC_PLAYER,	      true,  OldHandler<&ChatHandler::HandleEarnVIPCommand>,		   "", NULL },
        { "mall",           SEC_PLAYER,         true,  OldHandler<&ChatHandler::HandleMallCommand>,	          "", NULL },
	 { "unstuck",        SEC_PLAYER,         true,  OldHandler<&ChatHandler::HandleUnstuckCommand>,	          "", NULL },
	 { "coins",		SEC_PLAYER,	      true,  OldHandler<&ChatHandler::HandleEventCoinsCommand>,	   "", NULL },
	 { "customize",      SEC_PLAYER,         true,  OldHandler<&ChatHandler::HandleVIPCharCustomizeCommand>,	   "", NULL },
	 { "rename",         SEC_PLAYER,         true,  OldHandler<&ChatHandler::HandleVIPCharRenameCommand>,	   "", NULL },
	 { "changefaction",  SEC_PLAYER,         true,  OldHandler<&ChatHandler::HandleVIPFactionChangeCommand>,	   "", NULL },
	 { "changerace",     SEC_PLAYER,         true,  OldHandler<&ChatHandler::HandleVIPChangeRaceCommand>,	   "", NULL },
        { "maxlevel",       SEC_PLAYER,	      true,  OldHandler<&ChatHandler::HandleMaxLevelCommand>,            "", NULL },
        { "itemadd",        SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleItemAddCommand>,             "", NULL },
        { "item",           SEC_GAMEMASTER,     false, OldHandler<&ChatHandler::HandleItemCommand>,                "", NULL },
        { "gmappear",       SEC_MODERATOR,      false, OldHandler<&ChatHandler::HandleGMAppearCommand>,            "", NULL },
        { "gmsummon",       SEC_MODERATOR,      false, OldHandler<&ChatHandler::HandleGMSummonCommand>,            "", NULL },
