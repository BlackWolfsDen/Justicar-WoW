...
class ChatHandler
{
    ...
    protected:
       ...
       //vip commands
	bool HandleRemoveCustomAuras(const char* args);
	bool HandleEarnVIPCommand(const char* args);
	bool HandleVIPCharCustomizeCommand(const char* args);
	bool HandleVIPCharRenameCommand(const char* args);
	bool HandleVIPFactionChangeCommand(const char * args);
	bool HandleVIPChangeRaceCommand(const char * args);
	bool HandleEventCoinsCommand(const char * args);
	...
	bool HandleBerserkCommand(const char* args);
        bool HandleGMSummonCommand(const char* args);
        bool HandleGMAppearCommand(const char* args);
        bool HandleItemAddCommand(const char* args);
        bool HandleItemCommand(const char* args);
        bool HandleResetInstancesCommand(const char* args);
