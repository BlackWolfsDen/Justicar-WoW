...
#define MAX_MONEY_AMOUNT                       (0x77ce2a80-1)
...
class Player : public Unit, public GridObject<Player>
{
    ...
    public:
 	 ...
 	 void ClearAllCooldowns();
        ...
        uint32 GetVotingPoints(uint32 PlayerId);
        ...
        static void ClearBattlegroundChars();
	 ...
	 bool NotInPvPMall(uint32 & newArea);
	 bool isPVPArea(uint32 newArea);
	 bool isSanctuaryArea(uint32 newArea);
        ...
        bool CanModifyCreature(uint32 id);
