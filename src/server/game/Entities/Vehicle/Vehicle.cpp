...
bool Vehicle::AddPassenger(Unit* unit, int8 seatId)
{
    ...
    if (_me->GetMapId() == 30) // alterac valley
    {
	 if (!unit->ToPlayer()->HasAura(57724))
	 {
	 	ChatHandler(unit->ToPlayer()).PSendSysMessage("This is not your robot, therefor you can't control it. Pick your own robot!");
